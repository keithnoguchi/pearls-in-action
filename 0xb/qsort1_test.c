...
static int test_qsort1(int *i, const char *func_name,
...
int test_qsort1_random(int *i)
{
	return test_qsort1(i, __FUNCTION__, generate_random_array);
}

int test_qsort1_identical(int *i)
{
	return test_qsort1(i, __FUNCTION__, generate_identical_array);
}

int test_qsort1_sorted(int *i)
{
	return test_qsort1(i, __FUNCTION__, generate_sorted_array);
}
