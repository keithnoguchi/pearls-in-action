...
static int test_qsort4(int *i, const char *func_name,
...
int test_qsort4_random(int *i)
{
	return test_qsort4(i, __FUNCTION__, generate_random_array);
}

int test_qsort4_identical(int *i)
{
	return test_qsort4(i, __FUNCTION__, generate_identical_array);
}

int test_qsort4_sorted(int *i)
{
	return test_qsort4(i, __FUNCTION__, generate_sorted_array);
}
