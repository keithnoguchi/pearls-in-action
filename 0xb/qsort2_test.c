...
static int test_qsort2(int *i, const char *func_name,
...
int test_qsort2_random(int *i)
{
	return test_qsort2(i, __FUNCTION__, generate_random_array);
}

int test_qsort2_identical(int *i)
{
	return test_qsort2(i, __FUNCTION__, generate_identical_array);
}

int test_qsort2_sorted(int *i)
{
	return test_qsort2(i, __FUNCTION__, generate_sorted_array);
}
