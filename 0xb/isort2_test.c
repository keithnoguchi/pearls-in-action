...
static int test_isort2(int *i, const char *func_name,
...
int test_isort2_random(int *i)
{
	return test_isort2(i, __FUNCTION__, generate_random_array);
}

int test_isort2_identical(int *i)
{
	return test_isort2(i, __FUNCTION__, generate_identical_array);
}

int test_isort2_sorted(int *i)
{
	return test_isort2(i, __FUNCTION__, generate_sorted_array);
}
