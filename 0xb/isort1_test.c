...
static int test_isort1(int *i, const char *func_name,
...
int test_isort1_random(int *i)
{
	return test_isort1(i, __FUNCTION__, generate_random_array);
}

int test_isort1_identical(int *i)
{
	return test_isort1(i, __FUNCTION__, generate_identical_array);
}

int test_isort1_sorted(int *i)
{
	return test_isort1(i, __FUNCTION__, generate_sorted_array);
}
